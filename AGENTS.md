...
- `app.json/` — explain what lives here and when agents should edit it.
...
- `constants/` — explain what lives here and when agents should edit it.
- `expo-env.d.ts/` — explain what lives here and when agents should edit it.
